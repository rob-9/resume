...
\begin{document}
    ...
    \section{Education}
        ...
        \textit{Sep 2024 -- Jun 2027 $|$ GPA\@: 4.0}}
    ...
    \section{Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Developed \textbf{NestJS} microservices with \textbf{Kafka} streaming, powering KPI reporting for early enterprise pilots.
    ...
    \section{Projects}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                % \item Built infrastructure with \textbf{SageMaker} for model coordination, \textbf{Lambda} for serverless processing, and \textbf{LightSail} for deployment.
            \end{highlights}
        \end{onecolentry}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                % \item Used \textbf{OpenAI Whisper} for real-time speech analysis and feedback generation.
            \end{highlights}
        \end{onecolentry}
