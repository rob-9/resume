...
\usepackage[
    ...
    top=1.0 cm, % separation between body and page edge from the top
...
\begin{document}
    ...
    \begin{header}
        ...
        \normalsize
        % Cupertino, CA \hspace{0.05cm} $\cdot$ \hspace{0.05cm}
        \hrefWithoutArrow{tel:+14082031790}{\color{black}(408) 203--1790} \hspace{0.05cm} $\cdot$ \hspace{0.05cm}
        \hrefWithoutArrow{mailto:robert.ji888@gmail.com}{\color{black}robert.ji888@gmail.com} \hspace{0.05cm} $\cdot$ \hspace{0.05cm}
