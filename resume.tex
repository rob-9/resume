...
\begin{document}
    ...
    \begin{header}
        ...
        \normalsize
        \mbox{{\color{black}\footnotesize\faMapPin}\hspace*{0.05cm} Cupertino, CA}%
        \kern 0.2 cm%
        \AND%
        \kern 0.2 cm%
        \mbox{\hrefWithoutArrow{tel:+14082031790}{\color{black}{\footnotesize\faPhone*}\hspace*{0.05cm} (408) 203--1790}}%
        \kern 0.2 cm%
        \AND%
        \kern 0.2 cm%
        \mbox{\hrefWithoutArrow{mailto:roberj4@uci.edu}{\color{black}{\footnotesize\faPaperPlane[regular]}\hspace*{0.05cm} roberj4@uci.edu}}%
        \kern 0.2 cm%
        \AND%
        % \kern 0.25 cm%
        ...
        % \AND%
        \kern 0.2 cm%
        \mbox{\hrefWithoutArrow{https://linkedin.com/in/robert-ji}{\color{black}{\footnotesize\faLinkedinIn}\hspace*{0.05cm} linkedin.com/in/robert-ji}}%
        \kern 0.2 cm%
        \AND%
        \kern 0.2 cm%
        \mbox{\hrefWithoutArrow{https://github.com/rob-9}{\color{black}{\footnotesize\faGithub}\hspace*{0.05cm} github.com/rob-9}}%
    \end{header}
